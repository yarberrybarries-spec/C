...
<template>
  <section ref="pageRef" class="user-profile-page" v-loading="loading">
    <!-- 页头 -->
    <header class="profile-head">
      <div class="head-copy">
        <span class="eyebrow">PERSONAL PROFILE · IDENTITY CONTROL</span>
        <h1>个人中心</h1>
        <p>管理工程师身份、协作联系方式与账号安全状态。</p>
      </div>
      <div class="head-status">
        <span class="head-code">OPERATOR IDENTITY</span>
    ...
    <section class="identity-console">
      ...
      <div class="identity-main">
        ...
        <div class="identity-copy">
          <span class="identity-eyebrow">ACTIVE OPERATOR · 工程师身份</span>
    ...
    <div class="profile-grid">
      ...
      <section class="profile-panel ui-reveal">
        <header class="panel-head">
          <div>
            ...
            <h3>基础资料</h3>
            <p>{{ isEditing ? '修改用于任务协作的联系方式。' : '查看当前账号资料与身份归属。' }}</p>
          </div>
      ...
      <aside class="account-column">
        ...
        <section class="sync-panel ui-reveal">
          <span class="sync-code">DATA SYNC · 01</span>
          <h3>资料同步说明</h3>
          <p>联系方式保存后会同步到当前登录身份。姓名、工号、角色和账号状态由管理员统一维护。</p>
          <div class="sync-status"><i /> 身份数据链路在线</div>
        </section>
      </aside>
    </div>
  </section>
...
.security-action > span:nth-child(2) {
  display: flex;
  min-width: 0;
  flex-direction: column;
}
...
.action-arrow { color: var(--plaza-accent); font-size: 17px; }
